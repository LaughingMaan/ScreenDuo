...
Abstract:
	...
	This file contains the vendor-specific definitions.
...
__declspec(selectany)  uint8_t	image[sizeof(image_t) + (230400)];
__declspec(selectany)  uint8_t* data = image + sizeof(image_t);
//libusb_context* ctx;
//libusb_device_handle* device;
//bool SDLandlibusb = true;
int r;
int x2d(char x);
...
static char font8x8_extended[256][8] = {
	...
	{ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},   // U+009C_lusb::dev_write(device, image, sizeof(image));
	...
	{ 0x33, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},   // U+00A8 (dix2Daeresis)
...
inline size_t MsgEntry(char* entryBuf, size_t length);
extern void MsgSend(
	 WDFQUEUE   Queue,
	 WDFREQUEST Request,
	 size_t     length);
