...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, ScreenDuoDriverCreateDevice)
#pragma alloc_text (PAGE, ScreenDuoDriverEvtDevicePrepareHardware)
#endif
...
--*/
{
    ...
    pnpPowerCallbacks.EvtDevicePrepareHardware = ScreenDuoDriverEvtDevicePrepareHardware;
    ...
    if (NT_SUCCESS(status)) {
        ...
        status = WdfDeviceCreateDeviceInterface(
            device,
            &GUID_DEVINTERFACE_ScreenDuoDriver,
...
NTSTATUS
ScreenDuoDriverEvtDevicePrepareHardware(
