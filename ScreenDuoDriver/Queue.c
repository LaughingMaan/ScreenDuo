...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, ScreenDuoDriverQueueInitialize)
#endif

NTSTATUS
ScreenDuoDriverQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = ScreenDuoDriverEvtIoDeviceControl;
    queueConfig.EvtIoStop = ScreenDuoDriverEvtIoStop;
...
VOID
ScreenDuoDriverEvtIoDeviceControl(
    _In_ WDFQUEUE Queue,
